 ...
 * Mai 2022
 * DirectProd
 * newAdvert_controller.php - Contrôleur de la page de création d'annonce
 */
...
switch ($action) {
    case 'show': // Affichage de la page
        include 'vues/userAdverts/newAdvert.php';
        break;
    case 'submit': // Validation de l'annonce
        ...
        try {
            ...
            $idAdvert = Advert::addAdvert($advert);
        ...
        try {
            ...
            $_SESSION['messageAlert']['message'] = "Création d'annonce réussie !";
